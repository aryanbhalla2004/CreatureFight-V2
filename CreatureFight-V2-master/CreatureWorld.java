 ...
 * Teacher: Mr.Hardman
 * Date Last Modified: Novermber 22nd 2018
 * 
 */
...
public class CreatureWorld extends World
{
    ...
    /**
     * CreatureWorld is add world size and turning turnNumer 0
     * 
    ...
    /**
     * act is a method that is adding one and two player name in the world and also the button menu, and it is also adding the color of the menu and the cordinates. 
     * 
     * @param There are no parameters
